...
class JengaAgent(Agent):
    ...
    def __init__(self, opt, shared=None):
        ...
        # Load dict.
        if not shared:
            word_dict = JengaAgent.dictionary_class()(opt)
    ...
    def _init_from_scratch(self):
        ...
        self.model = DocReaderModel(objectview(self.opt), self.word_dict, self.feature_dict)
    ...
    def _init_from_saved(self, fname):
        ...
        self.model = DocReaderModel(objectview(self.opt), self.word_dict,
